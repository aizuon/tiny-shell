...
protected:
    std::shared_ptr<po::options_description> options_description = std::make_shared<po::options_description>("Allowed options");
    std::shared_ptr<po::positional_options_description> positional_options_description = std::make_shared<po::positional_options_description>();
